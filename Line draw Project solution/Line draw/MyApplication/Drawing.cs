...
namespace Line_draw
{
    public partial class Drawing : Form
    {
        ...
        public Rectangle GetRect(Point _Point1, Point _Point2)
        {
        ...
        private void openToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            if (OpenDlg.ShowDialog() == DialogResult.OK)
            {
                ...
                {
                    ShapeInfo = JsonConvert.DeserializeObject<ShapeData>(Convert.ToString(Data));
                }
                DrawSavedShapes();
        ...
        private void saveToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            {
                string Data = JsonConvert.SerializeObject(ShapeInfo);

                StreamWriter Writer = new StreamWriter(SaveDlg.FileName + ".MyExt");
                Writer.Write(Data);
                Writer.Close();
                ...
                DrawSavedShapes();
                ClicksCount = 0;
                //ShapeInfo = JsonConvert.DeserializeObject<ShapeData>(Data);
            }
        }
    }
